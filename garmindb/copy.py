...
class Copy():
    ...
    def copy_activities(self, activities_dir, latest=False):
        ...
        device_activities_dir = self.gc_config.device_activities_dir(self.device_mount_dir)
    ...
    def copy_monitoring(self, monitoring_dir, latest=False):
        ...
        device_monitoring_dir = self.gc_config.device_monitoring_dir(self.device_mount_dir)
    ...
    def copy_sleep(self, monitoring_dir, latest=False):
        ...
        device_sleep_dir = self.gc_config.device_sleep_dir(self.device_mount_dir)
    ...
    def copy_settings(self, settings_dir):
        ...
        device_settings_dir = self.gc_config.device_settings_dir(self.device_mount_dir)
